  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          ...
          <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
            <div className="flex flex-col gap-2 w-36 py-3 px-5 bgslate-100 text-gray-400 rounded">
              <p className="cursor-pointer hover:text-white">My Profile</p>
              <p className="cursor-pointer hover:text-white">Orders</p>
              <p className="cursor-pointer hover:text-white">Log Out</p>
            </div>
          </div>
        </div>
      ...
      <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? "w-full" : "w-0"}`}>
        <div className="felx felx-col text-gray-600">
